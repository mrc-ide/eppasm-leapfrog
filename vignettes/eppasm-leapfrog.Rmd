...
EPPASM can use the [leapfrog](https://github.com/hivtools/leapfrog) model during simulation and fitting. This vignette shows an example of using leapfrog with EPPASM.
