...
- [`agepregprev_lf()`](https://mrc-ide.github.io/eppasm-leapfrog/reference/agepregprev_lf.md)
  : Age-specific prevalence among pregnant women
- [`ageprev()`](https://mrc-ide.github.io/eppasm-leapfrog/reference/ageprev.md)
  : Prevalence by arbitrary age groups
- [`ageprev_lf()`](https://mrc-ide.github.io/eppasm-leapfrog/reference/ageprev_lf.md)
  : Prevalence by arbitrary age groups
...
- [`ancsite_pred_df_lf()`](https://mrc-ide.github.io/eppasm-leapfrog/reference/ancsite_pred_df_lf.md)
  : Prepare design matrix indices for ANC prevalence predictions
...
- [`ll_hhsage_binom_lf()`](https://mrc-ide.github.io/eppasm-leapfrog/reference/ll_hhsage_binom_lf.md)
  : Log likelihood for age-specific household survey prevalence using
  binomial approximation
- [`ll_hhsage_lf()`](https://mrc-ide.github.io/eppasm-leapfrog/reference/ll_hhsage_lf.md)
  : Log likelihood for age-specific household survey prevalence
- [`ll_hhsartcov()`](https://mrc-ide.github.io/eppasm-leapfrog/reference/ll_hhsartcov.md)
  : Log likelihood for age-specific household survey prevalence
- [`ll_hhsartcov_lf()`](https://mrc-ide.github.io/eppasm-leapfrog/reference/ll_hhsartcov_lf.md)
  : Log likelihood for age-specific household survey prevalence
...
- [`ll_hhsincid_lf()`](https://mrc-ide.github.io/eppasm-leapfrog/reference/ll_hhsincid_lf.md)
  : Log-likelhood for direct incidence estimate from household survey
...
- [`prep_fp_fitmod_lf()`](https://mrc-ide.github.io/eppasm-leapfrog/reference/prep_fp_fitmod_lf.md)
  : Prepare leapfrog inputs object for fitting and prepare likelihood
  data
...
- [`prepare_hhsageprev_likdat_lf()`](https://mrc-ide.github.io/eppasm-leapfrog/reference/prepare_hhsageprev_likdat_lf.md)
  : Prepare age-specific HH survey prevalence likelihood data
...
- [`prepare_likdat_lf()`](https://mrc-ide.github.io/eppasm-leapfrog/reference/prepare_likdat_lf.md)
...
- [`prepare_rhybrid_lf()`](https://mrc-ide.github.io/eppasm-leapfrog/reference/prepare_rhybrid_lf.md)
  : Setup the r-hybrid model
